    ...
    <body>
        <div class="container">
            ...
            <div class="row table-padding">
                <h3 class="text-center list">Client List</h3>
                <button class="btn btn-success pull-right btn-sm " onclick="location.href='<?php echo base_url();?>home/create_client';">Add Customer</button>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <button type="button" class="btn btn-warning btn-xs" onclick="location.href='<?php echo base_url();?>home/client_edit/{id}';">Edit</button>
                                            <!-- <button type="button" class="btn btn-danger btn-xs" onclick="location.href='<?php echo base_url();?>home/client_delete/{id}';">Delete</button> -->
                                        </div>
                                    </td>
                                </tr>
                            {/list}  
