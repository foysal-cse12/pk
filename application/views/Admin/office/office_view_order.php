    ...
    <body>
        <div class="container">
            ...
            <div class="row table-padding">
                <h3 class="text-center list">Office Order List</h3>
                <div class="panel panel-primary filterable">
                    <div class="panel-heading">
                        <h3 class="panel-title text-center">Order List (Office)</h3>
                        ...
                        <tbody>
                          {list}
                            <tr>
                                ...
                                <td>{name}</td>
                                <td>{supply_date}</td>
                                <td><a href="<?php echo base_url(); ?>office/specific_order_details_office/{id}" class="btn btn-info btn-xs">Details</a></td>
                            </tr>
                          {/list}
                        </tbody>
                    </table>
...
<body>
  <table align="center" border="2px">
     ...
     <tr>
       ...
       <td>{name}</td>
       <td>{supply_date}</td>
       <td><a href="<?php echo base_url(); ?>office/specific_order_details_office/{id}">Details</a></td>
     </tr>
     {/list}
