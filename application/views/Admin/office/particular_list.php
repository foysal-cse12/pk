    ...
    <body>
        <div class="container">
            ...
            <div class="row table-padding">
                <h3 class="text-center list">Particular List (Office)</h3>
                <button class="btn btn-success pull-right " onclick="location.href='<?php echo base_url();?>office/particulars_form';">Add New Particular</button>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <button type="button" class="btn btn-warning btn-xs" onclick="location.href='<?php echo base_url();?>office/particular_edit/{id}';">Edit</button>
                                            <!-- <button type="button" class="btn btn-danger btn-xs" onclick="location.href='<?php echo base_url();?>office/particular_delete/{id}';">Delete</button> -->
                                        </div>
                                    </td>
                                </tr>
                            {/list}  
