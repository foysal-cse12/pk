...
<meta charset="utf-8">
        ...
        <title> PK - Garments Management System | Conveyance List</title>
    ...
    <body>
        <div class="container">
            ...
            <div class="row table-padding">
                <h3 class="text-center list">Order List Of <?php echo $name;?>(Office)</h3>
                <div class="col-md-12">
                   <div class="col-md-7">
                    </div>
                            ...
                            <tr>
                                    ...
                                    ?>
                                        <div class="btn-group">
                                          ...
                                          <button type="button" class="btn btn-success btn-xs" onclick="location.href='<?php echo base_url();?>office/order_report_details/<?php echo $lists['id'] ;?>/<?php echo $eid;?>';">Details</button>
                                           
                                            <button type="button" class="btn btn-warning btn-xs" onclick="location.href='<?php echo base_url();?>office/order_report_edit/<?php echo $lists['id'] ;?>/<?php echo $eid;?>';">Edit</button>
                                            <!-- <button type="button" class="btn btn-danger btn-xs" onclick="location.href='<?php echo base_url();?>office/order_report_delete/<?php echo $lists['id'] ;?>/<?php echo $eid;?>';">Delete</button> -->
                                        </div>
                                    </td>
                                </tr>
