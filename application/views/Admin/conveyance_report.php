    ...
    <body>
        <div class="container">
            ...
            <div class="row table-padding">
                <h3 class="text-center list">Conveyance List Of <?php echo $name;?></h3>
                <div class="col-md-12">
                   <div class="col-md-7">
                    </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                    ...
                                    <?php 
                                       ...
                                       $eid = $lists['employee_id'] ;

                                    ?>
                                        <div class="btn-group">
                                           
                                            <button type="button" class="btn btn-warning btn-xs" onclick="location.href='<?php echo base_url();?>home/conveyance_report_edit/<?php echo $lists['id'] ;?>/<?php echo $eid;?>';">Edit</button>
                                            <!-- <button type="button" class="btn btn-danger btn-xs" onclick="location.href='<?php echo base_url();?>home/conveyance_report_delete/<?php echo $lists['id'] ;?>/<?php echo $eid;?>';">Delete</button> -->
                                        </div>
                                    </td>
                                </tr>
