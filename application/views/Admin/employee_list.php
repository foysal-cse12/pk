    ...
    <body>
        <div class="container">
            ...
            <div class="row table-padding">
                <h3 class="text-center list">Employee List</h3>
                <button class="btn btn-success pull-right btn-sm " onclick="location.href='<?php echo base_url();?>home/create_employee';">Add Employee</button>

                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                    <div class="panel panel-primary filterable">
                        <div class="panel-heading">
                            <h3 class="panel-title text-center">Employe  List</h3>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <button type="button" class="btn btn-warning btn-xs" onclick="location.href='<?php echo base_url();?>home/employee_edit/{id}';">Edit</button>
                                            <!-- <button type="button" class="btn btn-danger btn-xs" onclick="location.href='<?php echo base_url();?>home/employee_delete/{id}';">Delete</button> -->
                                        </div>
                                    </td>
                                </tr>
                            {/list}  
