    ...
    <body>
        <div class="container">
            ...
            <div id="main-container" class="row table-padding">
                <h3 class="text-center list">View Result (Factory)</h3>
                <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                        ...
                        <table class="table">
                            <thead>
                                <tr class="filters">
                                    ...
                                    <th><input type="text" class="form-control" placeholder="Payable Amount" disabled></th>
                            ...
                            {debit}
                                <tr>
                                    ...
                                    <td>{amount}</td>
                                    <!-- <td>{due_amount}</td> -->
                                    <!-- <td> <button type="button" class="btn btn-success btn-xs" onclick="location.href='<?php echo base_url();?>factory/pay_due_amount/{id}/{due_amount}';">Pay</button></td> -->
                                </tr>
                            {/debit}
                    ...
                    <div class="row">
                        <div class="col-md-offset-3 col-md-6 well total">
                            Total Payable Debit: {debit_sum}
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                        ...
                        <table class="table">
                            <thead>
                                <tr class="filters">
                                    ...
                                    <th><input type="text" class="form-control" placeholder="Total Amount" disabled></th>
                                    <th><input type="text" class="form-control" placeholder="Payable Amount" disabled></th>
                                    <!-- <th><input type="text" class="form-control" placeholder="Due Ammount" disabled></th> -->
                                </tr>
                            </thead>
                            <tbody>
                            {credit}
                    ...
                    <div class="row">
                        <div class="col-md-offset-3 col-md-6 well total">
                            Total Payable Credit: {credit_sum}
                        </div>                        
                    </div>
                </div>
            </div>
