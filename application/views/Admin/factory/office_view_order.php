            ...
            <div class="row table-padding">
                ...
                <div class="panel panel-primary filterable">
                    <div class="panel-heading">
                        <h3 class="panel-title text-center">Order List (Factory)</h3>
                        ...
                        <tbody>
                          {list}
                            <tr>
                               ...
                               <td><button type="button" class="btn btn-danger btn-xs"  onclick="location.href='<?php echo base_url();?>factory/facrory_order_delete/{id}';">Delete</button></td>
