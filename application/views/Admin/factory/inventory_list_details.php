...
<html lang="en">
    <head>
        ...
        <title> PK - Garments Management System | Inventory Details</title>
    ...
    <body>
        <div class="container">
            ...
            <div class="row" id="main-container">
                <h3 class="text-center list">Inventory Details(Factory)</h3>
                <div class="col-md-offset-3 col-md-6">
                    <div class="panel panel-default panel-horizontal">
                        <div class="panel-heading">
                            <h3 class="panel-title">Product Name</h3>
                        </div>
                        <div class="panel-body text-center">{product_category}</div>
                        <!-- <div class="panel-footer">Order Id</div> -->
                    </div>
                     <div class="panel panel-default panel-horizontal">
                        <div class="panel-heading">
                            <h3 class="panel-title">Suppliar</h3>
                        </div>
                        <div class="panel-body text-center">{suppliar}</div>
                    </div>
                    <div class="panel panel-default panel-horizontal">
                        <div class="panel-heading">
                            <h3 class="panel-title">Quantity</h3>
                        </div>
                        <div class="panel-body text-center"> {quantity} </div>
                    </div>
                    <div class="panel panel-default panel-horizontal">
                        <div class="panel-heading">
