    ...
    <body>
        <div class="container">
            ...
            <div class="row table-padding">
                <h3 class="text-center list">Factory Order</h3>
                             ...
                             {list}
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-primary btn-xs" onclick="location.href='<?php echo base_url();?>factory/product_order/{id}';">Product order</button>
                                           
                                        <button type="button" class="btn btn-success btn-xs" onclick="location.href='<?php echo base_url();?>factory/product_debit/{id}';">Debit</button>

                                        <button type="button" class="btn btn-info btn-xs" onclick="location.href='<?php echo base_url();?>factory/product_report/{id}';">Report</button>
