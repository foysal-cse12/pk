...
<html lang="en">
    <head>
        ...
        <title> PK - Garments Management System | Inventory List</title>
    ...
    <body>
        <div class="container">
            ...
            <div class="row table-padding">
                <h3 class="text-center list">Inventory List</h3>
                <button class="btn btn-success pull-right btn-sm " onclick="location.href='<?php echo base_url();?>factory/inventory';">Add Inventory</button>
                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                    <div class="panel panel-primary filterable">
                        <div class="panel-heading">
                            <h3 class="panel-title text-center">Inventory List</h3>
                        ...
                        <table class="table table-responsive">
                            <thead>
                                <tr class="filters">
                                    ...
                                    <th><input type="text" class="form-control" placeholder="Product Name" disabled></th>
                                    <th><input type="text" class="form-control" placeholder="Suppliar" disabled></th>
                            ...
                            <?php foreach ($list as $lists){?>
                                <tr>
						        	...
						        	<td><?php echo $lists['product_category']; ?></td>

						        	<td><?php echo $lists['suppliar'];?></td>
						        	<td><?php echo $lists['quantity'];?></td>
						        	<td><?php echo $lists['unit_price'];?></td>
                                    <td>
                                        <div class="btn-group">
                                           <button type="button" class="btn btn-success btn-xs" onclick="location.href='<?php echo base_url();?>factory/inventory_list_details/<?php echo $lists['id']; ?>';">Details</button>
                                            <button type="button" class="btn btn-warning btn-xs" onclick="location.href='<?php echo base_url();?>factory/inventory_list_edit/<?php echo $lists['id']; ?>';">Edit</button>
                                            <!-- <button type="button" class="btn btn-danger btn-xs"  onclick="location.href='<?php echo base_url();?>factory/inventory_list_delete/<?php echo $lists['id']; ?>';">Delete</button> -->
                                        </div>
                                    </td>
                                </tr>
                             <?php } ?> 
