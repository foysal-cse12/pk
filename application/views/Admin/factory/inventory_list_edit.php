            ...
            <div class="row main">
                <div class="panel-heading">
                   <div class="panel-title text-center">
                        <h1 class="title">Update Inventory Information</h1>
                        <hr />
                    </div>
                </div> 
                <div class="main-login main-center col-md-offset-4 col-lg-offset-4 col-sm-offset-4 col-md-4 col-xs-12 col-sm-4 col-lg-4">
                    <form class="form-horizontal" method="post" action="<?php echo base_url();?>factory/factory_inventory_data_edit">
                        ...
                        <!-- <div class="form-group">
                            ...
                            <div class="cols-sm-10">
                                <div class="input-group">
                                    ...
                                    <input  type="text" name="product_name" value="{product_name}" class="form-control"  id="pname"  placeholder="Enter your Product Name" required/>
                                </div>
                                ...
                                <div class="input-group">
                                    <select name="product_category" class="form-control"  id="date" required>   
                                       ...
                                       <option value="TWILL TAPE" <?php echo  set_select('product', 'TWILL TAPE', TRUE);?> >TWILL TAPE</option>
                                        ...
                                        <option value="" <?php echo  set_select('product_category', '', TRUE);?> >Select Service</option>
                                    </select>
                                </div>
                            </div>
                        </div> -->
                        <div class="form-group">
                            ...
                            <div class="cols-sm-10">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="suppliar" value="{suppliar}" class="form-control"  id="supplier"  placeholder="Enter your Supplier Name" />
                                </div>
