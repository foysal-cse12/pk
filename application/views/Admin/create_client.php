...
<html lang="en">
    <head>
        ...
        <title> PK - Garments Management System | ADD EMPLOYEE</title>
        ...
        <div class="container">
            ...
            <div class="row main">
                ...
                <div class="main-login main-center col-md-offset-4 col-lg-offset-4 col-sm-offset-4 col-md-4 col-xs-12 col-sm-4 col-lg-4">
                    <form class="form-horizontal" method="post" action="<?php echo base_url();?>home/create_client_data">
                        
                        <div class="form-group">
                            <label for="name" class="cols-sm-2 control-label">Cient/Company Name</label>
                            <div class="cols-sm-10">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-male" aria-hidden="true"></i></span>
                                    <input type="text" name="c_name" value="<?php echo set_value('c_name');?>" class="form-control"  id="pname"  placeholder="Enter your Client/Company Name" required/>
                                </div>
                                <span style="color:red"><?php echo form_error('c_name'); ?></span>
                            </div>
                        </div>
						...
						<div class="form-group">
                            ...
                            <div class="cols-sm-10">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="mobile" value="<?php echo set_value('mobile');?>" class="form-control"  id="price"  placeholder="Enter Employee Mobile" />
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="cols-sm-10">
                                <div class="input-group">
                                    ...
                                    <input type="email" name="email" value="<?php echo set_value('amount');?>" class="form-control"  id="price"  placeholder="Enter Email" />
                                </div>
