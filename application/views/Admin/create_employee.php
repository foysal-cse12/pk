        ...
        <div class="container">
            ...
            <div class="row main">
                ...
                <div class="main-login main-center col-md-offset-4 col-lg-offset-4 col-sm-offset-4 col-md-4 col-xs-12 col-sm-4 col-lg-4">
                    <form class="form-horizontal" method="post" action="<?php echo base_url();?>home/create_employee_data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="cols-sm-10">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="employee_name" value="<?php echo set_value('employee_name');?>" class="form-control"  id="pname"  placeholder="Enter your Employee Name" required/>
                                </div>
